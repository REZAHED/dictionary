...
try:
    ...
    for i in tqdm(range(43741,len(lines)),ncols=100):

        st = translator.translate(lines[i],src='ru', dest='fa')
        ...
        if c == 20:
            with open('translate_ru_en_2.json.json', 'w+', encoding='utf-8-sig') as file:
